...
public class Createleads extends Projectspecifi{
	...
	public void runcreadLead(String cname,String fname,String lname,String phno) {
		 ...
		 * =new String[3][4]; //for instansitation it starts from 1,1
		 * 
		 * //For declaring a data it starts from ,0,0
		 * 
		 * data[0][0] ="great"; data[0][1] ="shasti"; data[0][2] ="ram"; data[0][3] =
		 * "90";
		 * 
		 * 
		 * data[1][0] ="great1"; data[1][1] ="shasti1"; data[1][2] ="ram1"; data[1][3] =
		 * "90";
		 * 
		 * 
		 * data[2][0] ="great2"; data[2][1] ="shasti2"; data[2][2] ="ram2"; data[2][3] =
		 * "90";
		 * 
		 * return data; }
		 */
