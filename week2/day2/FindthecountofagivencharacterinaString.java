...
public class FindthecountofagivencharacterinaString {
	 ...
	 * Objective: The objective of this assignment is to understand the concepts of
	 * String manipulation, loops, and conditionals in Java. Specifically, it
	 * focuses on counting the occurrences of a given character in a String.
	 * Expected Completion Time: Best Case: 10 minutes Average Case: 15 minutes
	 * Assignment Details: Your task is to count the occurrences of character ‘e’ in
	 * the given String input="TestLeaf". 
	 * Requirements: - Create a class with a main method. 
	 ...
	 * - Finally, print the count Hints to solve: 
	 ...
	 * Expected Outcome: Upon completion, you should be: - Understand
	 * how to count the occurrences of a specific character in a String. - Grasp the
	 * fundamental principles of String manipulation and conditional logic in Java.
	 */
